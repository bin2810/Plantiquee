        ...
        <ul>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_1" class="collapse show dropdown-nav">
              <li>
                <a href="index.php" class="active">Thương Mại Điện Tử</a>
              </li>
            </ul>
          </li>
          <!-- <li class="nav-item nav-item-has-children">
          ...
          <!-- <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_5" class="collapse dropdown-nav">
              <li>
                <a href="form_danhmuc_add.php">Thêm Danh Mục</a>
              </li>
              <li>
                <a href="form_danhmuc_con_add.php">Thêm Danh Mục Con</a>
              </li>
              <li>
                <a href="form_sanpham_add.php">Thêm Sản Phẩm</a>
              </li>
            </ul> 
          </li> -->
          ...
          <li class="nav-item">
            <a href="danhsach_tintuc.php">
              ...
              <span class="text">Học Hỏi</span>
            </a>
          </li>
          <li class="nav-item">
            <a href="danhsach_donhang.php">
              <span class="icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M1.66666 4.16667C1.66666 3.24619 2.41285 2.5 3.33332 2.5H16.6667C17.5872 2.5 18.3333 3.24619 18.3333 4.16667V9.16667C18.3333 10.0872 17.5872 10.8333 16.6667 10.8333H3.33332C2.41285 10.8333 1.66666 10.0872 1.66666 9.16667V4.16667Z" />
              ...
              <div class="header-right">
                ...
                <div class="profile-box ml-15">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                    ...
                    <li>
                      <a href="../index.php">
                        <i class="lni lni-alarm"></i>Xem Trang Chủ
                      </a>
                    </li>
                    <!--<li>
