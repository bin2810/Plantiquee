      ...
      <main>
        ...
        ?>
          <div class="container-full bg-hochoi">
            ...
            ?>
              <h1><?=$tt['Tieu_De']?></h1>
              <img src="../asset/img/tintuc/<?=$hinhanh[0]?>" class="hinhanh_tieude_tintuc" alt="">
              ...
              <img src="../asset/img/tintuc/<?=$hinhanh[1]?>" class="hinh_tintuc" alt="">
